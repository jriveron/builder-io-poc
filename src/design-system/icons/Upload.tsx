...
type UploadIconVariant = 'outlined';
type UploadProps = IconProps & { variant?: UploadIconVariant };

const UploadOutlinedIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
...
> = {
  outlined: UploadOutlinedIcon,
} as const;

const UploadSVG: React.FC<UploadProps> = ({
  title,
  variant = 'outlined',
  ...props
}) => {
...
const Upload = styled(UploadSVG)(({ size = 'l', theme }) => {
