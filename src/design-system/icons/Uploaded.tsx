...
type UploadedIconVariant = 'outlined';
type UploadedProps = IconProps & { variant?: UploadedIconVariant };

const UploadedOutlinedIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
...
> = {
  outlined: UploadedOutlinedIcon,
} as const;

const UploadedSVG: React.FC<UploadedProps> = ({
  title,
  variant = 'outlined',
  ...props
}) => {
...
const Uploaded = styled(UploadedSVG)(({ size = 'l', theme }) => {
